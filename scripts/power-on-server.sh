...
HOSTS=(
    ...
    192.168.1.17  # Odin (PotentPi 1 [PiHole & PiVPN])
    192.168.1.18  # Mimir (PotentPi 2 [Internal Dashboard & Unifi Controller])
    192.168.1.19  # Loki (PotentPi 3 [Transmission Server])
    192.168.1.20  # Midguard (PotentPi 4 [Minecraft Server])
    192.168.1.21  # Frigg (PotentPi 5 [Home Assistant])
)
HOSTSDOWN=0
MACADDRS=(
